...
local config = {
	...
	root_dir = require("jdtls.setup").find_root({ ".git", "mvnw", "pom.xml", "build.gradle", ".jj" }), -- jj vcs FTW
	...
	settings = {
		java = {
			...
			home = "/home/evan/.local/share/mise/installs/java/21.0.2/bin/java",
			eclipse = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-21",
						path = "/home/evan/.local/share/mise/installs/java/21.0.2/bin/java",
					},
					{
						name = "JavaSE-24",
						path = "/home/evan/.local/share/mise/installs/java/24.0.1/bin/java",
					},
				},
			},
			maven = {
